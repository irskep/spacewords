...
var _default = plugin;
exports.default = _default;
},{"vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"../node_modules/strict-uri-encode/index.js":[function(require,module,exports) {
'use strict';
...
},{"strict-uri-encode":"../node_modules/strict-uri-encode/index.js","decode-uri-component":"../node_modules/decode-uri-component/index.js","split-on-first":"../node_modules/split-on-first/index.js"}],"../node_modules/stellardream/lib/weightedChoice.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/stellardream/lib/stars.js":[function(require,module,exports) {
"use strict";
...
var StarLuminosityMin = new Map([[StarType.M, 0.000158], [StarType.K, 0.086], [StarType.G, 0.58], [StarType.F, 1.54], [StarType.A, 4.42], [StarType.B, 21.2], [StarType.O, 26800]]);
exports.StarLuminosityMin = StarLuminosityMin;
var StarLuminosityMax = new Map([[StarType.M, 0.086], [StarType.K, 0.58], [StarType.G, 1.54], [StarType.F, 4.42], [StarType.A, 21.2], [StarType.B, 26800], [StarType.O, 78100000]]);
exports.StarLuminosityMax = StarLuminosityMax;
var StarRadiusMin = new Map([[StarType.M, 0.08], [StarType.K, 0.7], [StarType.G, 0.96], [StarType.F, 1.15], [StarType.A, 1.4], [StarType.B, 1.8], [StarType.O, 6.6]]);
exports.StarRadiusMin = StarRadiusMin;
...
function computeMetallicityValue(aRandomNumber, n2) {
  ...
  var val2 = dist2.ppf(aRandomNumber); // According to stats.stackexchange.com there's a super mathy way to
  // combine two Gaussian distributions, but using a weighted choice
  // seems to produce similar results, so whatever.

  return (0, _weightedChoice.default)([[val1, 1.5], [val2, 0.5]], n2);
}
...
function () {
  function Star(getRandom) {
    ...
    this.starType = (0, _weightedChoice.default)(weights, getRandom());
...
exports.Star = Star;
},{"./weightedChoice":"../node_modules/stellardream/lib/weightedChoice.js","gaussian":"../node_modules/gaussian/lib/gaussian.js"}],"../node_modules/stellardream/lib/planets.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Planet = exports.Moon = exports.PlanetTypeProbabilities = exports.PlanetTypeRadiusExponent = exports.PlanetTypeMassMax = exports.PlanetTypeMassMin = exports.PlanetType = void 0;
...
var PlanetTypeMassMin = new Map([[PlanetType.Terran, -1.3], [PlanetType.Neptunian, 0.22], [PlanetType.Jovian, 2]]);
exports.PlanetTypeMassMin = PlanetTypeMassMin;
var PlanetTypeMassMax = new Map([[PlanetType.Terran, 0.22], [PlanetType.Neptunian, 2], [PlanetType.Jovian, 3.5]]); // R = M^exponent
// Figure 3:
...
},{}],"../node_modules/stellardream/lib/moons.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addMoons = addMoons;
exports.MoonMass = void 0;
...
var MoonMass = new Map([[_planets.PlanetType.Terran, 0.01], [_planets.PlanetType.Neptunian, 0.001], [_planets.PlanetType.Jovian, 0.0001]]); /// Project a value 0-1 onto a range min-max

exports.MoonMass = MoonMass;

function normalizedToRange(min, max, val) {
  return min + (max - min) * val;
}

function addMoons(planet, hzMin, getRandom) {
  ...
  var hillSphereRadiusAU = planet.distance * Math.cbrt(planet.mass / planet.star.mass);
  var auKM = 149600000; // km

  var hillSphereRadiusKM = hillSphereRadiusAU * auKM;
  var earthRadiusKM = 6371;
  var planetRadiusKM = earthRadiusKM * planet.radius;
  var earthMassKG = 5.97 * 10e24;
  var numMoons = 0;
  var moonMassDistribution = null;
  var moonDistanceMinKM = 0;
  var moonDistanceMaxKM = 0;

  if (planet.planetType === _planets.PlanetType.Terran) {
    // Moons on rocky planets come from impacts, so let's imagine some impacts
    numMoons = (0, _weightedChoice.default)([[0, 75], [1, 25], [2, 5], [3, 1], [4, 0.1]], getRandom());
    moonMassDistribution = (0, _gaussian.default)(planet.mass * 0.01, planet.mass * 0.005);
    ...
    var numMoonsAvg = 5.3743 * Math.pow(planet.mass, 0.4876); // oops, the sun burned off our accretion disc, goodbye 90% of moons

    if (planet.distance < hzMin) numMoonsAvg *= 0.1;
    numMoons = (0, _gaussian.default)(numMoonsAvg, numMoonsAvg * 0.3).ppf(getRandom());
    moonMassDistribution = (0, _gaussian.default)(planet.mass * 0.0001, planet.mass * 0.00005);
    moonDistanceMinKM = 5 * planetRadiusKM;
    moonDistanceMaxKM = 30 * planetRadiusKM;
  } // smallest moon of jupiter is 0.0090 * 10e16 kg


  var moonMassMin = 0.0090 * 10e16 / earthMassKG;

  for (var i = 0; i < numMoons; i++) {
    var massVsEarth = Math.max(moonMassMin, moonMassDistribution.ppf(getRandom()) * planet.mass);
    var distanceKM = normalizedToRange(moonDistanceMinKM, moonDistanceMaxKM, getRandom());
    planet.moons.push(new _planets.Moon(distanceKM / auKM, massVsEarth));
  }
}
},{"gaussian":"../node_modules/gaussian/lib/gaussian.js","./weightedChoice":"../node_modules/stellardream/lib/weightedChoice.js","./planets":"../node_modules/stellardream/lib/planets.js"}],"../node_modules/stellardream/lib/addPlanets.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.normalizedToRange = normalizedToRange;
exports.addPlanets = addPlanets;
exports.closeBinaryProbability = void 0;
...
exports.closeBinaryProbability = closeBinaryProbability;

function addPlanets(starSystem, getRandom) {
  switch (starSystem.stars[0].starType) {
    case _stars.StarType.A:
    case _stars.StarType.B:
    case _stars.StarType.O:
  ...
  var numHotSlots = 5;
  var numColdSlots = 5;
  var planetSlots = [planetAnchor]; // Add slots away from the star
  ...
  if (forceHZTerran) {
    makePlanet(start, _planets.PlanetType.Terran);
  } else {
    makePlanet(start);
  ...
  for (var _i = 0, _b = starSystem.planets; _i < _b.length; _i++) {
    var planet = _b[_i];
    (0, _moons.addMoons)(planet, hzMin, getRandom);
  }
}
},{"./stars":"../node_modules/stellardream/lib/stars.js","./planets":"../node_modules/stellardream/lib/planets.js","./moons":"../node_modules/stellardream/lib/moons.js","./weightedChoice":"../node_modules/stellardream/lib/weightedChoice.js"}],"../node_modules/stellardream/lib/starSystem.js":[function(require,module,exports) {
"use strict";
...
var _addPlanets = require("./addPlanets");
...
function () {
  function StarSystem(seed) {
    ...
    if (alea() < _addPlanets.closeBinaryProbability) {
    ...
    this.planets = [];
    (0, _addPlanets.addPlanets)(this, alea);
    _a = (0, _stars.computeHabitableZone)(this.stars[0].starType, this.stars[0].luminosity), this.habitableZoneMin = _a[0], this.habitableZoneMax = _a[1];
  }
...
},{"alea":"../node_modules/alea/alea.js","./stars":"../node_modules/stellardream/lib/stars.js","./addPlanets":"../node_modules/stellardream/lib/addPlanets.js"}],"../node_modules/stellardream/lib/index.js":[function(require,module,exports) {
"use strict";
...
if (main) {
  ...
  for (var i = 0; i < 102; i++) {
    var system = new _starSystem.StarSystem(seed + j);
    j += 1;

    while (system.planets.length < 4) {
      system = new _starSystem.StarSystem(seed + i + j);
      j += 1;
    }
    ...
    for (var _i = 0, _a = system.stars; _i < _a.length; _i++) {
      ...
      starEl.innerHTML = star.starType == _stars.StarType.M ? "" : star.starType;
      ...
      starEl.style.borderRadius = (w / 2).toString() + 'px'; // console.table(system.stars[0]);
    }
    ...
    var _b = (0, _stars.computeHabitableZone)(system.stars[0].starType, system.stars[0].luminosity),
        hzMin = _b[0],
        hzMax = _b[1];
...
module.exports = {
  root: {
    groups: [{
      tags: [],
      phrases: ["[:starsdesc] [:planetsdesc]"]
    }]
  },
  starsdesc: {
    groups: [{
      tags: [["numstars", "1"]],
      phrases: ["The [name] system contains [:star1desc]."]
    }, {
      tags: [["numstars", "2"]],
      phrases: ["The [name] system contains [:star1desc] orbited by a smaller [:star2desc]."]
    }]
  },
  star1desc: {
    groups: [{
      ...
      tags: [["star1type", "K"]],
      phrases: ["a K-type star"]
    }, {
      tags: [["star1type", "G"]],
      phrases: ["a G-type star"]
    }, {
      tags: [["star1type", "F"]],
      phrases: ["an F-type star"]
    }, {
      tags: [["star1type", "A"]],
      phrases: ["an A-type star"]
    }, {
      tags: [["star1type", "B"]],
      phrases: ["a B-type star"]
    }, {
      tags: [["star1type", "O"]],
      phrases: ["an O-type star"]
    }]
  },
  star2desc: {
    groups: [{
  ...
  planetsdesc: {
    groups: [{
      ...
      phrases: ["[cap numberword numPlanets] planets orbit between [planetMinAU] AU and [planetMaxAU] AU from the primary star."]
    }, {
      tags: [["planetsAmount", "one"]],
      phrases: ["One planet orbits [planetMinAU] AU from the primary star."]
    }, {
      tags: [["planetsAmount", "none"]],
      phrases: ["The system is empty of planets."]
    }]
  }
};
},{}],"src/improvgrammar/planet.yaml":[function(require,module,exports) {
module.exports = {
  root: {
    groups: [{
...
var _LiterateStarSystem = _interopRequireDefault(require("./LiterateStarSystem"));
...
var _default = {
  ...
  setup: function setup() {
    ...
    function _iterateSearch(baseSeed) {
      ...
      var batchSize = 13;
      var allowedStarTypes = {
        'K': true,
        'G': true,
        'F': true
      };
      var minPlanets = 2;
      var starSystem = system.value;
      ...
      for (var s = baseSeed; s < baseSeed + batchSize; s++) {
        var _starSystem = new _stellardream.StarSystem(s);

        if (!allowedStarTypes[_starSystem.stars[0].starType]) {
          continue;
        }

        if (_starSystem.planets.length < minPlanets) {
          continue;
        }
        ...
        try {
          for (var _iterator = _starSystem.planets[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var planet = _step.value;
            var isCold = planet.distance > _starSystem.habitableZoneMax;
            var isHot = planet.distance < _starSystem.habitableZoneMin;
            var isTidallyLocked = !isCold && _starSystem.stars[0].starType == 'M';
    ...
    return {
      seed: seed,
      system: system,
      systemJSON: (0, _compositionApi.computed)(function () {
        if (!system.value) return "null";
        return JSON.stringify(system.value.starSystem, null, 2);
      }),
      traveledSystemsCount: traveledSystemsCount,
      travel: travel,
      search: search,
      stop: stop,
      isStopped: isStopped
...
exports.default = _default;
        var $77783c = exports.default || module.exports;
      
      if (typeof $77783c === 'function') {
        $77783c = $77783c.options;
      }
    
        /* template */
        Object.assign($77783c, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c("main", [
    _c("nav", [
      _c("div", [
        _vm._v(
          "\n      Visited " +
            _vm._s(_vm.traveledSystemsCount) +
            " " +
            _vm._s(_vm.traveledSystemsCount == 1 ? "system" : "systems") +
            "\n    "
        )
      ]),
      _vm._v(" "),
      _c("button", { on: { click: _vm.travel } }, [_vm._v("Travel")]),
      _vm._v(" "),
      _c("button", { on: { click: _vm.search } }, [_vm._v("Search for life")]),
      _vm._v(" "),
      !_vm.isStopped ? _c("button", [_vm._v("Stop")]) : _vm._e()
    ]),
    _vm._v(" "),
    _vm.system
      ? _c(
...
var staticRenderFns = [
  function() {
    ...
    return _c("footer", [
      ...
      _vm._v(" "),
      _c("div", [
        _c("a", { attrs: { href: "https://steveasleep.com/stellardream" } }, [
          _vm._v("Stellar Dream")
        ]),
        _vm._v(
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$77783c', $77783c);
          } else {
            api.reload('$77783c', $77783c);
          }
        }
...
},{"@vue/composition-api":"../node_modules/@vue/composition-api/dist/vue-composition-api.module.js","query-string":"../node_modules/query-string/index.js","stellardream":"../node_modules/stellardream/lib/index.js","./LiterateStarSystem":"src/LiterateStarSystem.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"src/main.js":[function(require,module,exports) {
"use strict";
